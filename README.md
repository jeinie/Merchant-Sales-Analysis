# Franchise Sales Monitoring Platform

지도 기반으로 프랜차이즈 가맹점의 매출 현황을 시각화하고, 본사 관리자와 영업 담당자가 매장별 운영 상태를 빠르게 파악할 수 있도록 만든 매출 모니터링 대시보드입니다.

단순 매출 조회가 아니라 최근 월 매출, 전월 대비 성장률, 거래 건수, 객단가, 업종/지역 평균 비교 지표를 함께 보여주며, Gemini API를 활용해 본사/영업 담당자 관점의 AI 운영 인사이트를 생성합니다.
...
목표는 여러 가맹점 중 어떤 매장을 우선적으로 확인해야 하는지, 어떤 지표를 지속적으로 모니터링해야 하는지 판단할 수 있도록 돕는 것입니다.
